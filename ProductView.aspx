    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div class="divDet1">
                ...
                <span class="proOgPriceView">Retail: Rs.<%#Eval("RetailPrice","{0:c}") %></span><p class="proPriceView">Rent: Rs. <%#Eval("RentPrice","{0:c}") %></p><p class="proPriceView">Security: Rs. <%#Eval("SecurityPrice","{0:c}") %><span class="proPriceDiscountView">(Refundable)</span></p>
            </div>
            <div >
                ...
                <div class="form-group col-md-12">
                    <h5 class="h5size">Delivery Date</h5>
                    
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" TextMode="Date"  min="2021-07-24" max="2022-12-31"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatordob" runat="server" CssClass ="text-danger" ErrorMessage="*plz Enter your Delivery Date" ControlToValidate="TextBox1" ForeColor="Red"></asp:RequiredFieldValidator>
                    <br />
                    <h5 class="h5size">Return Date</h5>
                    <asp:TextBox ID="retdate" runat="server" CssClass="form-control" TextMode="Date"  min="2021-06-01" max="2022-12-31"></asp:TextBox>
                       
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass ="text-danger" ErrorMessage="*plz Enter your Return Date" ControlToValidate="retdate" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div >
                ...
                <p><%# ((int)Eval("Availability")==1)? "Available":""  %></p>
