                ...
                <hr />
                 ...
                 <div class ="form-group">
                    ...
                    <div class ="col-md-3 ">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorMainCatID" runat="server" CssClass ="text-danger " ErrorMessage="*plz Select Main Category" ControlToValidate="ddlMainCatID" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
         ...
         <ItemTemplate>
             <tr>
                 ...
                 <td><%# Eval("CatName") %>   </td>
                    ...
                    <td><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl= '<%# Eval("SubCatID", "~/EditSubCategory.aspx?bid={0}") %>' >Edit</asp:HyperLink></td>
                </tr>
         </ItemTemplate>
