...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class ="container">
     <div class ="form-horizontal">
           ...
           <div class ="form-group">
               <asp:Label ID="Label2" runat="server" CssClass ="col-md-2 control-label" Text="RetailPrice"></asp:Label>
               <div class ="col-md-3">
                   <asp:TextBox ID="txtRetailPrice" CssClass ="form-control" runat="server"></asp:TextBox>
               </div>
           </div>


           <div class ="form-group">
               <asp:Label ID="Label3" runat="server" CssClass ="col-md-2 control-label" Text="SecurityPrice"></asp:Label>
               <div class ="col-md-3">
                   <asp:TextBox ID="txtSecurityPrice" CssClass ="form-control" runat="server"></asp:TextBox>
               </div>
           </div>

         <div class ="form-group">
               <asp:Label ID="Label20" runat="server" CssClass ="col-md-2 control-label" Text="RentPrice"></asp:Label>
               <div class ="col-md-3">
                   <asp:TextBox ID="txtRentPrice" CssClass ="form-control" runat="server"></asp:TextBox>
               </div>
           </div>
         ...
         <div class ="form-group">
               <asp:Label ID="Labelq" runat="server" CssClass ="col-md-2 control-label" Text="Quantity"></asp:Label>
               <div class ="col-md-3">
          ...
          <div class ="form-group">
               <asp:Label ID="Label17" runat="server" CssClass ="col-md-2 control-label" Text="Availability"></asp:Label>
               <div class ="col-md-3">
              ...
              <div class="form-group">
                <div class="table table-responsive">
                    ...
                    <Columns>  
                        ...
                        <asp:BoundField DataField="SecurityPrice" HeaderText="Security Price" /> 
