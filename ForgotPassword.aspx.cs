    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["retrorentalsdbconnectionstring"].ConnectionString)) 
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody ="Hi ,"+Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> http://localhost:61927/RecoverPassword.aspx?id="+myGUID ;


                MailMessage PassRecMail = new MailMessage("20CS901001@kristujayanti.com", ToEmailAddress );
