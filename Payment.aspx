            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                <div id="wallets" class="tab-pane fade show active">
                    <h3>HOME</h3>
                    <p>Some content.</p>
                    <asp:Button ID="btnPaytm" OnClick="btnPaytm_Click" runat="server" Text="Pay Now" />
                </div>
             ...
             <div class="tab-content">
                                <div id="PlaceNPay" class="tab-pane fade in active">
                                    <h3>Place your order and Pay using our <a href="acceptedpayments" target="_blank">Accepted Payments</a> channels, Your order will be Placed only upon receiving full payment.</h3>
