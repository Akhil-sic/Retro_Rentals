            ...
            <div class ="form-horizontal ">
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-3 ">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtCategoryName" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Category Name" ControlToValidate="txtCategory" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
     ...
     <asp:repeater ID="rptrCategory" runat="server">
         ...
         <ItemTemplate>
             <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl= '<%# Eval("CatID", "~/EditCategory.aspx?bid={0}") %>' >Edit</asp:HyperLink></td>
                </tr>
         </ItemTemplate>
